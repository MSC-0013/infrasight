...
import { ah as useAuthStore, y as StatusBadge, R as ROLE_LABEL, a3 as generateOrganizations, P as generateAuditLogs, O as generateApiKeys, ab as generateTimeSeries, B as Button, a2 as generateMembers, M as generateAlerts, a as Dialog, b as DialogContent, e as DialogHeader, f as DialogTitle, c as DialogDescription, I as Input, Y as generateIncidents, U as generateDeployments, a6 as generateSLOs, F as cn, a8 as generateServices, X as generateEvents, aa as generateThroughputSeries, _ as generateLatencySeries, T as Tabs, A as TabsList, C as TabsTrigger, z as TabsContent, a0 as generateMLInsights, af as generateWorkers, a5 as generateQueues, a4 as generateQueueLagSeries, W as generateEventDistribution, ac as generateTimelineEvents, J as JSONViewer, ai as useInspector, G as formatDistanceToNow$1 } from "./router-BDT-YXA5.mjs";
import { A as AlertCard } from "./alert-card-fZXHhHHz.mjs";
import { Q as QueueCard } from "./queue-card-jtee5hmB.mjs";
import { W as WorkerCard } from "./worker-card-Di21iMlE.mjs";
...
import { C as ChartBar, B as Bell, u as Flame, ab as Workflow, F as FileText, Q as OctagonAlert, G as GitBranch, P as Network, a1 as ShieldCheck, A as Activity, f as Building2, K as KeyRound, U as Plus, a0 as Settings, aa as Users, a2 as Sparkles, z as ListFilter, V as RefreshCw, D as Download, j as ChevronRight, r as Cpu, L as Layers, a7 as TriangleAlert, W as Rocket, k as ChevronUp, h as ChevronDown } from "../_libs/lucide-react.mjs";
...
const ROLE_VIEW = {
  ...
  developer: {
    ...
    actions: [
      ...
      { to: "/services", label: "Service health", icon: ChartBar, hint: "Your services" }
    ],
    kpis: [
  ...
  viewer: {
    ...
    tone: "success",
    actions: [
      { to: "/services", label: "Service health", icon: ChartBar, hint: "Live" },
...
function AdminDashboard() {
  ...
  const [inviteRole, setInviteRole] = reactExports.useState("developer");
