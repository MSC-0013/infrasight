...
import { ab as generateTimeSeries, B as Button, y as StatusBadge } from "./router-BDT-YXA5.mjs";
import "../_libs/sonner.mjs";
import { A as Activity, c as ArrowRight, v as Github, ad as Zap, o as Clock, w as Globe, a6 as TrendingUp, ab as Workflow, C as ChartBar, P as Network, B as Bell, G as GitBranch, a2 as Sparkles, g as Check } from "../_libs/lucide-react.mjs";
...
const DEMO_ACCOUNTS = [{
  ...
  role: "Super Admin",
  tone: "critical",
  desc: "Full platform control, org governance, audit trails",
  perms: ["All features", "Org & billing", "API keys & SSO", "Audit trails"]
}, {
  email: "ops@pulse.io",
  password: "ops123",
  role: "Admin",
  tone: "error",
  desc: "Workspace admin, team & billing management",
  perms: ["Manage users", "Settings & API keys", "Alerts & incidents", "Audit log"]
}, {
  email: "sre@pulse.io",
  password: "sre123",
  role: "SRE",
  tone: "warning",
  desc: "Incidents, deployments, infrastructure health",
  perms: ["Manage incidents", "Deployments & queues", "Alerts & workers", "All observability"]
}, {
  email: "dev@pulse.io",
  password: "dev123",
  role: "Developer",
  tone: "info",
  desc: "Traces, logs, queues, debugging tools",
  perms: ["Traces & logs", "Events & services", "Manage incidents", "Deployments & MLOps"]
}, {
  email: "viewer@pulse.io",
  password: "viewer123",
  role: "Viewer",
  tone: "success",
  desc: "Read-only dashboards for stakeholders",
  perms: ["View dashboards", "Alerts & incidents", "Service health", "SLOs & heatmaps"]
}];
const tooltipStyle = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-7xl items-center justify-between px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-6 text-xs text-muted-foreground md:flex", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#demo", className: "hover:text-foreground", children: "Demo" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-7 gap-1.5 text-xs", children: [
          "Get started ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 flex flex-wrap gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "h-9 gap-2", children: [
          "Launch console ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 rounded-lg border border-border bg-card p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-3.5 w-3.5 text-success" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Live event throughput" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { tone: "success", children: "streaming" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: "847k events/sec · p95 142ms" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: sparkline, margin: {
          top: 4,
          right: 8,
          left: -16,
          bottom: 0
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "hero-g", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "value", stroke: "var(--color-primary)", strokeWidth: 1.5, fill: "url(#hero-g)" })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-border bg-border md:grid-cols-4", children: [{
        label: "Events / sec",
        value: "847k",
        icon: Zap
      }, {
        ...
        value,
        icon: Icon
      }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card px-5 py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-mono text-2xl tabular-nums", children: value })
      ] }, label)) })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "demo", className: "border-b border-border bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-mono uppercase tracking-wider text-primary", children: "Demo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 text-3xl font-semibold tracking-tight", children: "Sign in with any role." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Five role-based dashboards, each with unique permissions and layouts. Use the credentials below to explore every view." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-5", children: DEMO_ACCOUNTS.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { tone: a.tone, children: a.role }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1.5 font-mono text-[11px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: a.email })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Password" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: a.password })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-[11px] text-muted-foreground", children: a.desc }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 space-y-1", children: a.perms.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-1.5 text-[10px] text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2.5 w-2.5 text-success" }),
          " ",
          p
        ] }, p)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "mt-4 block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-7 w-full gap-1.5 text-xs", children: [
          "Sign in ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3 w-3" })
        ] }) })
      ] }, a.email)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "pricing", className: "border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-20 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-3 max-w-xl text-sm text-muted-foreground", children: "Pick a role, sign in, and explore the live dashboard — no setup required." }),
