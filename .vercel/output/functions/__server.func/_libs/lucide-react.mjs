...
const ChartBar = createLucideIcon("chart-bar", __iconNode$S);
const __iconNode$R = [
  ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
...
const Grid3x2 = createLucideIcon("grid-3x2", __iconNode$x);
const __iconNode$w = [
...
const MemoryStick = createLucideIcon("memory-stick", __iconNode$q);
const __iconNode$p = [
  [
    "path",
    {
...
const Pin = createLucideIcon("pin", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
