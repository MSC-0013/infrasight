...
import { o as Route$p, ae as generateTraces, I as Input, G as formatDistanceToNow, y as StatusBadge } from "./router-C7vl9p1Y.mjs";
import { E as EmptyState } from "./empty-state-C3AUFrgK.mjs";
import "../_libs/sonner.mjs";
import { a0 as Search, ac as Workflow } from "../_libs/lucide-react.mjs";
...
function TracesPage() {
  const rawSearch = Route$p.useSearch();
  const search = {
    q: rawSearch.q ?? "",
