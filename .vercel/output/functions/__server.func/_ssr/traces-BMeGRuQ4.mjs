...
import { X as generateTraces, q as formatDistanceToNow, l as StatusBadge } from "./router-F21aWjaR.mjs";
...
function TracesPage() {
  ...
  const filtered = traces.filter((t) => !q || t.id.includes(q) || t.rootOperation.includes(q) || t.rootService.includes(q));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b border-border bg-background px-6 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-md flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q, onChange: (e) => setQ(e.target.value), placeholder: "trace.id, service, operation… try: duration:>1000ms", className: "h-8 border-border bg-card pl-8 font-mono text-xs" })
      ] }),
